...
intervals_from_file = function(path_to_file, filter = FALSE, 
 ...
 # log = log[!log[,3]%in%toRemove,]
  ...
  if(return == "both"){
    results = list(intervals, median(intervals), mean(intervals), sd(intervals), length(intervals))
    names(results) = c("intervals", "median", "mean", "standard deviation", "n_behaviors")
  }
...
#kmers_from_file("C:\\Users\\Lillian\\OneDrive - University Of Houston\\Alward lab\\Boris projects\\WT Mirror Assay Experimental data\\Kmer files\\", seconds = 1.936708, kmer = 2)
#male_median = 1.42505
#female_median = 1.936708
#"C:\\Users\\Lillian\\OneDrive - University Of Houston\\Alward lab\\Boris projects\\WT Mirror Assay Experimental data\\Kmer files\\"
#write.csv(test, "C:\\Users\\Lillian\\OneDrive - University Of Houston\\Alward lab\\Boris projects\\WT Mirror Assay Experimental data\\Kmer files\\test.csv")

kmers_from_file("/Users/lillianjackson/Library/CloudStorage/OneDrive-UniversityOfHouston/Alward lab/Project updates/WT Mirror Assays - aim 1/WT Mirror Assay data BORIS - kmer/WT mirror female new - kmer/", seconds = , kmer = 2)
...
kmers_from_file = function(path_to_file, seconds, kmer){
  ...
  bouts = Filter(function(x) dim(x)[1] > kmer, bouts)
...
kmers_from_directory = function(dir, seconds, kmer){
  ...
  for(i in 1:length(files)){
    ...
    kmer_list[[i]] = kmers_from_file(paste(dir, files[i], sep=""), seconds, kmer)
  }
...
#C:\\Users\\Lillian\\OneDrive - University Of Houston\\Alward lab\\Boris projects\\WT Mirror Assay Experimental data\\Kmer files\\Kmer output\\Females
#C:\\Users\\Lillian\\OneDrive - University Of Houston\\Alward lab\\Boris projects\\WT Mirror Assay Experimental data\\Kmer files\\Kmer output\\Males
